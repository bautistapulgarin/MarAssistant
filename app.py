...
<div style="position:fixed; bottom:100%; left:50%; font-size:40px; opacity:1; animation:floatY 0s ease-in-out infinite; z-index:9999;">🎄</div>
<div style="position:fixed; bottom:100%; left:50%; font-size:20px; opacity:1; animation:floatY 0s ease-in-out infinite; z-index:9999;">🎁</div>
<div style="position:fixed; bottom:100%; left:50%; font-size:15px; opacity:1; animation:floatY 0s ease-in-out infinite; z-index:9999;">🎁</div>
