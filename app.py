...
<div style="position:fixed; bottom:2%; left:4%; font-size:25px; opacity:0.7; animation:floatY 3s ease-in-out infinite; z-index:9999;">🦌</div>
<div style="position:fixed; bottom:6%; left:6%; font-size:25px; opacity:0.7; animation:floatY 2.8s ease-in-out infinite; z-index:9999;">🦌</div>
<div style="position:fixed; bottom:3%; left:11%; font-size:30px; opacity:0.7; animation:floatY 3.2s ease-in-out infinite; z-index:9999;">🦌</div>
""", unsafe_allow_html=True)
