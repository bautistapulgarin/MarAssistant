...
<div style="position:fixed; bottom:70%; left:4%; font-size:25px; opacity:1; animation:floatY 3s ease-in-out infinite; z-index:9999;">🦌</div>
<div style="position:fixed; bottom:70%; left:6%; font-size:25px; opacity:1; animation:floatY 2.8s ease-in-out infinite; z-index:9999;">🦌</div>
<div style="position:fixed; bottom:70%; left:8%; font-size:27px; opacity:1; animation:floatY 3.2s ease-in-out infinite; z-index:9999;">🦌</div>
