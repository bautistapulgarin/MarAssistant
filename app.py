...
<div style="position:fixed; bottom:5%; left:5%; font-size:22px; opacity:0.9; z-index:0;">🎃</div>
<div style="position:fixed; bottom:8%; left:7%; font-size:20px; opacity:0.85; z-index:0;">🎃</div>
<div style="position:fixed; bottom:6%; left:9%; font-size:18px; opacity:0.9; z-index:0;">🎃</div>
