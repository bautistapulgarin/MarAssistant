...
<div style="position:fixed; top:25%; right:6%; font-size:20px; opacity:0.1; animation:floatDown 16s linear infinite; z-index:9999;">❄️</div>

<!-- Calabazas en la parte inferior izquierda (rebote suave) -->
<div style="position:fixed; bottom:5%; left:3%; font-size:22px; opacity:0.9; animation:floatY 3s ease-in-out infinite; z-index:9999;">🎃</div>
<div style="position:fixed; bottom:8%; left:5%; font-size:20px; opacity:0.85; animation:floatY 2.8s ease-in-out infinite; z-index:9999;">🎃</div>
<div style="position:fixed; bottom:6%; left:7%; font-size:18px; opacity:0.9; animation:floatY 3.2s ease-in-out infinite; z-index:9999;">🎃</div>
""", unsafe_allow_html=True)
