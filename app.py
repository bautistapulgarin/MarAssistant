...
<div style="position:fixed; top:0%; right:5%; font-size:25px; opacity:0.3; animation:floatDown 15s linear infinite; z-index:9999;">👻</div>
<div style="position:fixed; top:20%; right:7%; font-size:23px; opacity:0.5; animation:floatDown 18s linear infinite; z-index:9999;">👻</div>
<div style="position:fixed; top:10%; right:6%; font-size:20px; opacity:0.4; animation:floatDown 14s linear infinite; z-index:9999;">👻</div>
