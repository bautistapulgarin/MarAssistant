...
<div style="position:fixed; bottom:86%; left:14%; font-size:25px; opacity:1; animation:floatY 3s ease-in-out infinite; z-index:9999;">🦌</div>
<div style="position:fixed; bottom:86%; left:12%; font-size:25px; opacity:1; animation:floatY 2.8s ease-in-out infinite; z-index:9999;">🦌</div>
<div style="position:fixed; bottom:86%; left:16%; font-size:27px; opacity:1; animation:floatY 3.2s ease-in-out infinite; z-index:9999;">🦌</div>
