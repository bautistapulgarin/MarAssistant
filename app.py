...
<div style="position:fixed; bottom:6%; left:16%; font-size:30px; opacity:1; animation:floatY 0s ease-in-out infinite; z-index:9999;">🛷</div>
<div style="position:fixed; bottom:7.2%; left:16%; font-size:25px; opacity:1; animation:floatY 0s ease-in-out infinite; z-index:9999;">🎅🏻</div>
""", unsafe_allow_html=True)
