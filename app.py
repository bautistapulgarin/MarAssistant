...
<div style="position:fixed; top:0%; right:5%; font-size:25px; opacity:0.3; animation:floatDown 15s linear infinite; z-index:9999;">❄️</div>
<div style="position:fixed; top:20%; right:7%; font-size:23px; opacity:0.5; animation:floatDown 18s linear infinite; z-index:9999;">❄️</div>
<div style="position:fixed; top:10%; right:6%; font-size:20px; opacity:0.4; animation:floatDown 14s linear infinite; z-index:9999;">❄️</div>

<!-- Calabazas en la parte inferior izquierda (rebote suave) -->
<div style="position:fixed; bottom:5%; left:7%; font-size:29px; opacity:0.9; animation:floatY 3s ease-in-out infinite; z-index:9999;">🎃</div>
<div style="position:fixed; bottom:8%; left:9%; font-size:27px; opacity:0.85; animation:floatY 2.8s ease-in-out infinite; z-index:9999;">🎃</div>
<div style="position:fixed; bottom:6%; left:11%; font-size:25px; opacity:0.9; animation:floatY 3.2s ease-in-out infinite; z-index:9999;">🎃</div>
""", unsafe_allow_html=True)
